...
class KintoSDK {
    ...
    async createNewWallet() {
        return new Promise((resolve, reject) => {
            ...
            const popup = window.open(`${this.kintoUrl}/onboarding?appDomain=${encodeURIComponent(window.location.origin)}`, 'Kinto Onboarding', `width=${width},height=${height},left=${left},top=${top}`);
            if (!popup) {
...
export const createKintoSDK = (appAddress) => new KintoSDK(appAddress);
